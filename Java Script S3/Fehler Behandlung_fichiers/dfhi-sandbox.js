...
/* harmony import */ var _font_fontinsans_fontinsans_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var _font_fontinsans_fontinsans_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_font_fontinsans_fontinsans_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _font_sourcecodepro_sourcecodepro_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _font_sourcecodepro_sourcecodepro_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_font_sourcecodepro_sourcecodepro_css__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _asciidoctor_stylesheet_factory_stylesheets_dfhi_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4);
/* harmony import */ var _asciidoctor_stylesheet_factory_stylesheets_dfhi_css__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_asciidoctor_stylesheet_factory_stylesheets_dfhi_css__WEBPACK_IMPORTED_MODULE_2__);
//Look and feel
...
(function(mod) {
  if (true) // CommonJS
    mod(__webpack_require__(0), __webpack_require__(7), __webpack_require__(5), __webpack_require__(6));
  else {}
})(function(CodeMirror) {
  "use strict";
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var acorn_namespaceObject = {};
__webpack_require__.r(acorn_namespaceObject);
__webpack_require__.d(acorn_namespaceObject, "version", function() { return version; });
__webpack_require__.d(acorn_namespaceObject, "parse", function() { return parse; });
__webpack_require__.d(acorn_namespaceObject, "parseExpressionAt", function() { return parseExpressionAt; });
__webpack_require__.d(acorn_namespaceObject, "tokenizer", function() { return tokenizer; });
__webpack_require__.d(acorn_namespaceObject, "Parser", function() { return Parser; });
__webpack_require__.d(acorn_namespaceObject, "defaultOptions", function() { return defaultOptions; });
__webpack_require__.d(acorn_namespaceObject, "Position", function() { return Position; });
__webpack_require__.d(acorn_namespaceObject, "SourceLocation", function() { return SourceLocation; });
__webpack_require__.d(acorn_namespaceObject, "getLineInfo", function() { return getLineInfo; });
__webpack_require__.d(acorn_namespaceObject, "Node", function() { return Node; });
__webpack_require__.d(acorn_namespaceObject, "TokenType", function() { return TokenType; });
__webpack_require__.d(acorn_namespaceObject, "tokTypes", function() { return types; });
__webpack_require__.d(acorn_namespaceObject, "keywordTypes", function() { return keywords$1; });
__webpack_require__.d(acorn_namespaceObject, "TokContext", function() { return TokContext; });
__webpack_require__.d(acorn_namespaceObject, "tokContexts", function() { return types$1; });
__webpack_require__.d(acorn_namespaceObject, "isIdentifierChar", function() { return isIdentifierChar; });
__webpack_require__.d(acorn_namespaceObject, "isIdentifierStart", function() { return isIdentifierStart; });
__webpack_require__.d(acorn_namespaceObject, "Token", function() { return Token; });
__webpack_require__.d(acorn_namespaceObject, "isNewLine", function() { return isNewLine; });
__webpack_require__.d(acorn_namespaceObject, "lineBreak", function() { return lineBreak; });
__webpack_require__.d(acorn_namespaceObject, "lineBreakG", function() { return lineBreakG; });
__webpack_require__.d(acorn_namespaceObject, "nonASCIIwhitespace", function() { return nonASCIIwhitespace; });
var walk_namespaceObject = {};
__webpack_require__.r(walk_namespaceObject);
__webpack_require__.d(walk_namespaceObject, "simple", function() { return simple; });
__webpack_require__.d(walk_namespaceObject, "ancestor", function() { return ancestor; });
__webpack_require__.d(walk_namespaceObject, "recursive", function() { return recursive; });
__webpack_require__.d(walk_namespaceObject, "full", function() { return full; });
__webpack_require__.d(walk_namespaceObject, "fullAncestor", function() { return fullAncestor; });
__webpack_require__.d(walk_namespaceObject, "findNodeAt", function() { return findNodeAt; });
__webpack_require__.d(walk_namespaceObject, "findNodeAround", function() { return findNodeAround; });
__webpack_require__.d(walk_namespaceObject, "findNodeAfter", function() { return findNodeAfter; });
__webpack_require__.d(walk_namespaceObject, "findNodeBefore", function() { return findNodeBefore; });
__webpack_require__.d(walk_namespaceObject, "make", function() { return make; });
__webpack_require__.d(walk_namespaceObject, "base", function() { return base; });

// EXTERNAL MODULE: ./src/html/dfhi.js
var dfhi = __webpack_require__(1);

// EXTERNAL MODULE: ./node_modules/codemirror/lib/codemirror.css
var codemirror = __webpack_require__(8);

// EXTERNAL MODULE: ./src/html/ejs/ejs.css
var ejs = __webpack_require__(9);

// EXTERNAL MODULE: ./node_modules/codemirror/mode/javascript/javascript.js
var javascript = __webpack_require__(5);
...
var htmlmixed = __webpack_require__(10);

// EXTERNAL MODULE: ./node_modules/codemirror/addon/edit/matchbrackets.js
var matchbrackets = __webpack_require__(11);
...
Array.prototype.push.apply(acorn_data.$LONE, acorn_data.General_Category);
acorn_data.gc = acorn_data.General_Category;
acorn_data.sc = acorn_data.Script_Extensions = acorn_data.scx = acorn_data.Script;
...
pp$9.regexp_validateUnicodePropertyNameAndValue = function(state, name, value) {
  if (!acorn_data.hasOwnProperty(name) || acorn_data[name].indexOf(value) === -1) {
    state.raise("Invalid property name");
  }
};
pp$9.regexp_validateUnicodePropertyNameOrValue = function(state, nameOrValue) {
  if (acorn_data.$LONE.indexOf(nameOrValue) === -1) {
    state.raise("Invalid property name");
  }
};
...
// CONCATENATED MODULE: ./src/html/ejs/sandbox.js



let acorn = acorn_namespaceObject;
acorn.walk = walk_namespaceObject;
...
var lib_codemirror = __webpack_require__(0);
var lib_codemirror_default = /*#__PURE__*/__webpack_require__.n(lib_codemirror);

// CONCATENATED MODULE: ./src/html/ejs/ejs.js


const LAST_CHAP_NUM = 20;
const CONTENT_CONTAINER_TAG = "body"; // replace <article> tag of EJ
...
window.addEventListener("load", () => {
    ...
    if (window.chapNum && window.chapNum < LAST_CHAP_NUM && window.localStorage && !localStorage.getItem("usedSandbox")) {
        let pres = document.getElementsByTagName("pre");
        for (let i = 0; i < pres.length; i++) {
            let pre = pres[i];
            if (!/^(text\/)?(javascript|html)$/.test(pre.getAttribute("data-language")) ||
                chapNum === 1 && !/console\.log/.test(pre.textContent)) {
                console.log(`${i} -> ${pre.textContent}`);
                continue;
            }
            sandboxHint = buildElement("div", {"class": "sandboxhint"},
    ...
    function buildElement(type, attrs) {
        let firstChild = 1;
    ...
    lib_codemirror_default.a.commands[lib_codemirror_default.a.keyMap.default.Down = "lineDownEscape"] = cm => {
        let cur = cm.getCursor();
        if (cur.line === cm.lastLine()) {
            document.activeElement.blur();
            return lib_codemirror_default.a.Pass;
        } else {
            cm.moveV(1, "line");
        }
    };
    lib_codemirror_default.a.commands[lib_codemirror_default.a.keyMap.default.Up = "lineUpEscape"] = cm => {
        let cur = cm.getCursor();
    ...
    let nextID = 0;
    let article = document.getElementsByTagName(/*"article"*/CONTENT_CONTAINER_TAG)[0];
    ...
    function activateCode(node, e, lang) {
        ...
        let wrap = node.parentNode.insertBefore(buildElement("div", {"class": "editor-wrap"}), node);
        let editor = lib_codemirror_default()(div => wrap.insertBefore(div, wrap.firstChild), {
            value: code,
            mode: lang,
            extraKeys: keyMap,
            matchBrackets: true,
        ...
        let out = wrap.appendChild(buildElement("div", {"class": "sandbox-output"}));
        let menu = wrap.appendChild(buildElement("div", {"class": "sandbox-menu", title: "Sandbox menu..."}));
    ...
    function openMenu(data, node) {
        let menu = buildElement("div", {"class": "sandbox-open-menu"});
        ...
        if (!data.isHTML || !data.sandbox) {
            items.push(["Deactivate editor (ctrl-down)", () => {
                closeCode(data);
            }]);
        }
        items.forEach(choice => menu.appendChild(buildElement("div", choice[0])));
        function click(e) {
            let target = e.target;
    ...
    function getSandbox(name, forHTML, callback) {
        ...
        let options = {loadFiles: window.sandboxLoadFiles},
            html = '';
...
// CONCATENATED MODULE: ./src/html/dfhi-sandbox.js
// DFHI
...
/***/ })
/******/ ]);
//# sourceMappingURL=dfhi-sandbox.f42857bca391.js.map